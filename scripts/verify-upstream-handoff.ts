...
//   bun scripts/verify-upstream-handoff.ts --record docs/upstream-review-<sha12>.json [--allow-pending]
//
...
// ---------------------------------------------------------------------------
// Record files (docs/upstream-baseline.json, docs/upstream-review-*.json)
// ---------------------------------------------------------------------------
