...
## September 18 programme amendment

Apply [MASTER's G1–G12 amendment](../../MASTER.md#programme-decision-amendment--september-18-2026-g1g12), exported in [accepted decisions](ACCEPTED-DECISIONS.md#programme-decision-amendment--september-18-2026-g1g12), before conflicting historical instructions below. The finite baseline, integrated-delivery priority, scoped local-commit permission, adaptive Best-of-N, evidence-based reviewer qualification, effect-free inference replacement, bounded standing exploration and milestone budgets govern future implementation. Required native/publication gates remain pending explicit reconciliation; this record activates no route, grant or goal.

[CONTINUATION-GOAL.md](CONTINUATION-GOAL.md) is the complete compact objective prepared from this interview, pending owner application in the existing session. [The grill report](../report/omp-programme-grill-2026-09-18.md) distinguishes decisions, engineering tasks, authority boundaries and preserved scope. All original requirements below and both full specification exports remain, subject only to explicit amendments.
