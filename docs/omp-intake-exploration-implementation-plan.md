...
| E2 | OMP-268 — `4daad6ca-0213-4aff-b026-878c5793fb02` | Durable branch execution, screening, synthesis/deepening, reservation, caps, cancellation, staleness, recovery and containment; E1+NSI-4 | r3 — `84cc75f8-6f9f-4bcc-9683-cf61b917073b` (was r2 — `af997771-8a69-5afe-bf82-cb56a79d2128`) |
...
OMP-268's r3 (`84cc75f8-6f9f-4bcc-9683-cf61b917073b`) is a verified description-only successor to r2 (`af997771-8a69-5afe-bf82-cb56a79d2128`, preserved here as history), applying the accepted 03B scope — description contract v2 (2026-09-09) directly into `revision.description`; the OMP-268-s02 evidence records the applied description's SHA-256 as `83632d9bc1ada168133bf04b301202c30fd2ecb2bccd346050fe5d23df72a3c5` with an exact-readback **PASS**, and title, scope, criteria, state, candidate, relations, NOW, focus, grants and effects all unchanged. The v2 clauses state E2's role-specific applicability without widening scope: **A** keeps generation/synthesis comparison inside the existing synthesis call, with no sibling comparison or extra critic call; **B** enforces only the one existing eligible structural branch slot with immutable original inputs; **C** persists the exact ingress/valid/duplicate/shortfall counts and preserves the raw valid pool without padding, deletion or automatic retry/spend; **D** preserves the identities, pool and evidence E4's separate posture/frame/breadth and concept-coverage contrasts need, without itself authorizing those trials. This is a documentation/description correction only: it makes no runtime, NSI-4, qualification, receipt or activation claim, and it does not complete any acceptance criterion.

**E3 description contract v2 (2026-09-09; pending external application).** OMP-269 requires an expected-revision successor to r2 (`c56247d2-4aa5-5600-81c5-7a2c9b9f3436`) that preserves its five structured acceptance criteria verbatim and makes their owner-applicable role explicit: **A** presents synthesis-owned comparative tradeoffs/watch-outs without asking generators to rank, prune or hide valid proposals and keeps deterministic screening distinct from advisory model judgment; **B** preserves the reviewed frame/operator and eligibility/selection/fallback identities of the existing structural slot while keeping ratified inputs and constraints distinct from labeled counterfactuals; **C** keeps the wider valid pool accessible, reports target/returned/invalid/quarantined/valid/duplicate/distinct-valid/shortfall evidence without converting unknown to zero, padding options, retrying or spending automatically; **D** links prominent options to the full pre-synthesis pool so E4 can measure independent pre/post concept coverage while preserving framed/unframed/equal-compute controls. Disposable CLI/Web projections remain replayable read-only views of native committed facts: they cannot become another ledger, scheduler or mutation authority, and spoofed clients, stale selections or mismatched source identity refuse. The exact external mutation is recorded in `NOTES-EXTERNAL.md`; no source/runtime implementation, qualification, fixture, canary, N4, local/remote rollout, readiness, acceptance or activation claim follows while qualified E2, NSI-5 and retained H0 admission evidence remain unresolved.
