...
Then wait for its verdict-structured report and copy it VERBATIM into the typed Linear review comment (linear tool, action:"comment", kind:"review"). A NEEDS_FIX verdict still gets forwarded — it ends this summary attempt; fixes happen afterward and the next owner-entered /summary spawns a fresh auditor.
