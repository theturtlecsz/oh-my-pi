# 0010 — Research campaign lifecycle, action vocabulary, and authority boundaries (R02-S2)
...
- Database schema migration `0037_research_campaign_lifecycle.sql` widens state constraints, adds outcome and blocked dependency columns, enforces post-admission invariants, and maintains full backward readability for historical pre-0037 records.
